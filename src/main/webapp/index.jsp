...
<%@ include file="/include/SideBar.jsp" %>
          ...
          <div class="card z-index-2 ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                <div class="chart">
                  <canvas id="chart-bars" class="chart-canvas" height="212" width="440" style="display: block; box-sizing: border-box; height: 170px; width: 352.7px;"></canvas>
                </div>
              </div>
            </div>
            <div class="card-body">
          ...
          <div class="card z-index-2  ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                <div class="chart">
                  <canvas id="chart-line" class="chart-canvas" height="212" width="440" style="display: block; box-sizing: border-box; height: 170px; width: 352.7px;"></canvas>
                </div>
              </div>
            </div>
            <div class="card-body">
          ...
          <div class="card z-index-2 ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                <div class="chart">
                  <canvas id="chart-line-tasks" class="chart-canvas" height="212" width="440" style="display: block; box-sizing: border-box; height: 170px; width: 352.7px;"></canvas>
                </div>
              </div>
            </div>
            <div class="card-body">
  ...
  <%@ include file="/include/footer.jsp" %></main>
